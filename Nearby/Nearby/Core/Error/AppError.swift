...
enum AppError: Error, LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        ...
        case .tokenExpired:          return "만료된 토큰입니다"
        case .invalidToken:          return "유효하지 않은 토큰입니다"
        case .notFound:              return "리소스를 찾을 수 없습니다"
        case .internalServerError:   return "서버 오류가 발생했습니다"
        case .decodingError:         return "데이터 변환 중 오류가 발생했습니다"
        case .networkFail:           return "네트워크 연결에 실패했습니다"
        case .missingConfig(let key): return "\(key) 설정이 누락되었습니다."
        case .kakaoOAuthError:       return "카카오톡 로그인에 실패했습니다."
        case .invalidPresignedUrl:   return "유효하지 않은 업로드 URL입니다"
        }
    }
}
