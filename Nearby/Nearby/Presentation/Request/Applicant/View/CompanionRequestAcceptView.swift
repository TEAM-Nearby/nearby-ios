...
final class CompanionRequestAcceptView: BaseView {
    ...
    override func setStyle() {
        ...
        chatDescriptionLabel.do {
            $0.setFont(.b2M16, text: "(호스트)님이 만남 약속을 위한 오픈채팅방을 열어뒀어요. 입장해서 인사를 나눠보세요!", textColor: .grey50)
            $0.numberOfLines = 0
            $0.textAlignment = .center
        }
        ...
        enterChatButton.do {
            ...
            $0.backgroundColor = .primary.withAlphaComponent(0.15)
    ...
    override func setUI() {
        addSubviews(imageView, titleLabel, informationView, checkListView, chatCardView, confirmButton)
    ...
    func updateStep(_ step: CompanionRequestAcceptViewModel.Step) {
        ...
        informationView.isHidden = isChat
        checkListView.isHidden = isChat
        chatCardView.isHidden = !isChat
    }
